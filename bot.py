...
genai.configure(api_key=os.getenv("GOOGLE_API_KEY"))  # Make sure your .env file has GOOGLE_API_KEY set
...
with st.sidebar:
    ...
    **Rakhi Kshirasagar**  
    ...
    - 🏛️ College: S.G. Balekundri Institute of Technology  
    - 🛠️ Contribution: UI Design, Feature Integration, Testing  
    """)
    st.markdown("""
    **Amol Kambar**  
    - 🎓 USN: 2BU24AD009 
    ...
    **Saloni Sulkar**  
    ...
    - 🏫 Dept: Artificial Intelligence & Data Science  
    - 🏛️ College: S.G. Balekundri Institute of Technology  
    - 🛠️ Contribution: UI Design, Asthetics,Testing 
    """)
    st.markdown("""
    **Pranav Misal**  
    - 🎓 USN: 
